...
const Login = ({ language = 'en' }: LoginProps) => {
  ...
  const selectedLanguage = useMemo(() => language || 'en', [language]);

  const t = useMemo(() => {
    return loginTranslations[selectedLanguage as keyof typeof loginTranslations] || loginTranslations.en;
  }, [selectedLanguage]);
  ...
  }, [email, password, name, isSignUp, signIn, signUp, t, selectedLanguage]);
          ...
          <form onSubmit={handleAuth} className="space-y-4">
            ...
            <div className="text-center text-sm text-gray-500 mt-4">
              ...
              <Button
                ...
                onClick={() => toast.info(t.contactSupport)}
              >
                {t.forgotPassword}
              </Button>
            </div>
